...
public class BatchJobConfig {
    ...
    public Job userMofificationJob(final JobRepository jobRepository,
                                   ...
                                   final @Qualifier("sayHelloToSombraTeam") Step sayHelloToSombraTeam,
    ...
    @Bean("sayHelloToSombraTeam")
    public Step sayHelloToSombraTeam(final JobRepository jobRepository,
                                   final @Qualifier("transactionManager") PlatformTransactionManager transactionManager) {
        return new StepBuilder("Say Hello To Sombra Team", jobRepository)
                .tasklet((contribution, chunkContext) -> {
                    log.info("Say Hello To Sombra Team. . . ");
                    return RepeatStatus.FINISHED;
                },transactionManager)
                .build();
    }
